...
function FormularioBrigadas() {
    const [registros, setRegistros] = useState([]);
    const [tipoFormulario, setTipoFormulario] = useState('salida');
...
ReactDOM.render(<FormularioBrigadas />, document.getElementById('formulario'));
